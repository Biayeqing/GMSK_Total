transcript file transcript_100k_wave.log
transcript on
...
add wave -noupdate sim:/$TOP_NAME/uut/u_top_gmsk/rx_lowpass_out_vd_Q
...
add wave -noupdate sim:/$TOP_NAME/uut/u_top_gmsk/downsample_out_vd_Q
...
add wave -divider {Optional onephase wires}
add_wave_safe sim:/$TOP_NAME/uut/u_top_gmsk/polyfir_vld
add_wave_safe -radix decimal sim:/$TOP_NAME/uut/u_top_gmsk/polyfir_I
add_wave_safe -radix decimal sim:/$TOP_NAME/uut/u_top_gmsk/polyfir_Q
...
catch {configure wave -namecolwidth 240}
