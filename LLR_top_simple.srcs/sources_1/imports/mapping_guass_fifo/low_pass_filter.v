...
initial begin
    // 滤波器系数初始化
    // Normalized by 32776/33144.  Together with the Gaussian-filter
    // gain (8190), one bipolar symbol now produces exactly 2^22 phase
    // counts, i.e. h=0.5, without long-term DDS phase drift.
    filt_coeff[0]  = 16'hFF7D;
    filt_coeff[1]  = 16'h007E;
    filt_coeff[2]  = 16'h00AE;
    filt_coeff[3]  = 16'h00E9;
    filt_coeff[4]  = 16'h0108;
    filt_coeff[5]  = 16'h00EB;
    filt_coeff[6]  = 16'h007D;
    filt_coeff[7]  = 16'hFFBD;
    filt_coeff[8]  = 16'hFEC5;
    filt_coeff[9]  = 16'hFDC8;
    filt_coeff[10] = 16'hFD0D;
    filt_coeff[11] = 16'hFCE4;
    filt_coeff[12] = 16'hFD8E;
    filt_coeff[13] = 16'hFF34;
    filt_coeff[14] = 16'h01D7;
    filt_coeff[15] = 16'h0544;
    filt_coeff[16] = 16'h091F;
    filt_coeff[17] = 16'h0CEA;
    filt_coeff[18] = 16'h101F;
    filt_coeff[19] = 16'h1242;
    filt_coeff[20] = 16'h1300;
