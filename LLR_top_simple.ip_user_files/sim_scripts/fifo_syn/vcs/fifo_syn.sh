...
#
# Script generated by Vivado on Wed Jun 03 08:35:56 +0800 2026
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : fifo_syn.sh
...
#
# Usage        : fifo_syn.sh
#                fifo_syn.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo_syn.sh [-reset_run]
#                fifo_syn.sh [-reset_log]
#                fifo_syn.sh [-help]
#
...
#                script (type 'fifo_syn.sh -help' for more information).
#
...
# script info
echo -e "fifo_syn.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo_syn.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fifo_syn xil_defaultlib.glbl -o fifo_syn_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fifo_syn_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fifo_syn_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fifo_syn_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fifo_syn.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fifo_syn.sh [-help]\n\
Usage: fifo_syn.sh [-step]\n\
Usage: fifo_syn.sh [-lib_map_path]\n\
Usage: fifo_syn.sh [-reset_run]\n\
Usage: fifo_syn.sh [-reset_log]\n\
Usage: fifo_syn.sh [-keep_index]\n\
Usage: fifo_syn.sh [-noclean_files]\n\n\
