...
#
# Script generated by Vivado on Wed Jun 03 08:35:53 +0800 2026
...
#
# Usage        : dds_ip.sh
#                dds_ip.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dds_ip.sh [-reset_run]
#                dds_ip.sh [-reset_log]
#                dds_ip.sh [-help]
#
...
#                script (type 'dds_ip.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xbip_utils_v3_0_10 -libname axi_utils_v2_0_6 -libname xbip_pipe_v3_0_6 -libname xbip_bram18k_v3_0_6 -libname mult_gen_v12_0_18 -libname xbip_dsp48_wrapper_v3_0_4 -libname xbip_dsp48_addsub_v3_0_6 -libname xbip_dsp48_multadd_v3_0_6 -libname dds_compiler_v6_0_22 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xbip_utils_v3_0_10 axi_utils_v2_0_6 xbip_pipe_v3_0_6 xbip_bram18k_v3_0_6 mult_gen_v12_0_18 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_6 xbip_dsp48_multadd_v3_0_6 dds_compiler_v6_0_22 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "dds_ip.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dds_ip.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.dds_ip xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.dds_ip -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log dds_ip_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dds_ip.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dds_ip.sh [-help]\n\
Usage: dds_ip.sh [-step]\n\
Usage: dds_ip.sh [-lib_map_path]\n\
Usage: dds_ip.sh [-reset_run]\n\
Usage: dds_ip.sh [-reset_log]\n\
Usage: dds_ip.sh [-keep_index]\n\
Usage: dds_ip.sh [-noclean_files]\n\n\
