...
design_libs=(xpm xbip_utils_v3_0_10 axi_utils_v2_0_6 xbip_pipe_v3_0_6 xbip_bram18k_v3_0_6 mult_gen_v12_0_18 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_6 xbip_dsp48_multadd_v3_0_6 dds_compiler_v6_0_22 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dds_ip xil_defaultlib.glbl -o dds_ip_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dds_ip_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key dds_ip_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dds_ip_simv.daidir vcs_lib c.obj)
